...
namespace MatNETIO.types
{
    ...
    public class MLCell : MLArray
    {
        ...
        /// <summary>
		/// Public accessor to the cell array for n-dimensions (specified by subscripts).
		/// Looks a little wired though.
		/// </summary>
        public MLArray this[int[] subscripts]
        {
            set { _cells[GetIndex(subscripts)] = value; }
            get { return (MLArray) _cells[GetIndex(subscripts)]; }
        }
		...
		/// TODO:Need to condsider multidimension (>=3) situations
