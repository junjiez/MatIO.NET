...
{
    /// <summary>
    /// Mat-file reader. Reads Mat-files into <c>MLArray</c> objects.
    /// </summary>
    /// <example>
    /// <code>
    ///         // read in the file
    ...
    public class MatFileReader
    {
        ...
        /// <summary>
        /// Container for reading <c>MLArray</c>s
        /// </summary>
        ...
        /// <summary>
        /// Creates instance of <c>MatFileReader</c> and reads Mat-file with the name
        /// <c>fileName</c>.
        /// </summary>
        /// <remarks>
        ...
        public MatFileReader(string fileName):this(fileName, new MatFileFilter())
        { }
        ...
        public MatFileReader(string fileName, MatFileFilter filter)
        {
            ...
            // try to open uo the file as read-only
            FileStream dataIn;
            try
            {
            ...
            // try read in the file until completed
            try
            {
                ReadHeader(dataIn);
        ...
        private void ReadHeader(Stream buf)
        {
            ...
            {
                // right now, this version of MatNETIO does not support Big Endian
                throw new MatlabIOException("This version of MatNETIO does not support Big Endian.");
            }
        ...
        /// <summary>
        /// Reads data fro the <c>BinaryReader</c> stream. Searches for each 
        ...
        private void ReadData(Stream buf)
        {
            ...
            switch (tag.Type)
            {
                case MatDataTypes.miCOMPRESSED:
                    // inflate adn recur
                    {
                        Stream uncompresssed = Inflate(buf, tag.Size);
                        ReadData(uncompresssed);
                        uncompresssed.Close();
                    }
                    break;
        ...
        private class ISMatTag : MatTag
        {
            ...
            public ISMatTag(Stream buf) : base(0, 0)
            {
